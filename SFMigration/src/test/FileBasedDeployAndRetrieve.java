...
//sample.run();
//sample.retrieveZip("sateesh.chava@techmahindra.com","abc123456Ii7BP2QsTX77zvchBQP4txc8");
sample.deployZip("sateesh.chava@techmahindra.com","abc123456Ii7BP2QsTX77zvchBQP4txc8");
}
...
private void deployZip(String username,String pwd) throws Exception {
...
public void retrieveZip(String userName,String pwd) throws Exception {
    String path="SFDC\\sateesh.chava@techmahindra.com";
...
File resultsFile = new File("SFDC\\sateesh.chava@techmahindra.com\\"+ZIP_FILE);
